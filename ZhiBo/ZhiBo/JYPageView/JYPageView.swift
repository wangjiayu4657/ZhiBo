...
class JYPageView: UIView {
    ...
    fileprivate lazy var contentView : JYContentView = JYContentView(frame: CGRect.init(x: 0, y: self.style.titleHiight, width: self.bounds.width, height: self.bounds.height), childVCs: childVCs, parentVC: parentVC)
